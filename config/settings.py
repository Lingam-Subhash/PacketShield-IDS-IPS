...
# ACK Flood detection
ACK_FLOOD_THRESHOLD = 5
ACK_FLOOD_WINDOW = 3.0
...
# DDoS detection
DDoS_THRESHOLD = 3     # number of distinct source IPs
DDoS_WINDOW = 5.0         # seconds
